...
export default function Support() {
  ...
  return (
    <div className="max-w-7xl mx-auto p-6 pb-0 h-screen flex flex-col gap-4 overflow-hidden">
      ...
      />
      <section className="flex-1 pt-2 overflow-y-auto">
        <div className="grid grid-cols-11 gap-4 bg-gray-900 text-white border border-gray-200 rounded-lg py-2 px-4 mb-2 items-center text-sm">
          <p className="col-span-4">Message</p>
          <p className="col-span-1 text-xs">Status</p>
          <p className="col-span-2 text-xs">Type</p>
          <p className="col-span-1 text-xs text-right">Created</p>
          <p className="col-span-3 text-xs">Admin Comment</p>
        </div>
        <ListLoading
          isLoading={loading}
          items={feedbacks}
          ...
          {(feedback) => {
            return (
              ...
              >
                ...
                <div className="col-span-2">
                  <span
                    className={
                      ...
                      feedbackTypeConfig[
                        feedback.feedbackType as keyof typeof feedbackTypeConfig
                      ].color
                    }
                  ></span>
                  <span className="ml-2">
                ...
                <p className="col-span-1 text-gray-800 text-right">
