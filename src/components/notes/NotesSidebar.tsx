      ...
      <div className="p-4 border-b border-gray-200">
        ...
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2 text-sm rounded-lg bg-gray-100 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:bg-white"
          />
        </div>
      </div>
        ...
        {filteredNotes.map((note) => (
          <div
            ...
            className={`p-4 border-b border-gray-100 cursor-pointer hover:bg-gray-50 ${
              currentNote?._id === note._id ? "bg-indigo-50" : ""
            }`}
          >
