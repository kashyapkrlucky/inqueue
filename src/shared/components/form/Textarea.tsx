    ...
    <div className={`flex flex-col gap-2 ${boxClassName}`}>
      ...
      {/* <div className="w-full flex items-center gap-2 rounded-xl border border-gray-200 bg-white focus-within:border-gray-900 focus-within:ring-2 focus-within:ring-gray-900/10"> */}
        <textarea
          ...
          rows={3}
          style={{ resize }}
          className="h-full w-full p-3 rounded-xl text-sm text-gray-900 outline-none border border-gray-200 bg-white focus-within:border-gray-900 focus-within:ring-2 focus-within:ring-gray-900/10 placeholder:text-gray-400"
          {...props}
        />
      {/* </div> */}
      {description && (
