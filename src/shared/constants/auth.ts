...
// Content
export const CREATE_ACCOUNT_CONTENT = "Create your account";
export const JOIN_APP_CONTENT = "Join AtlasId today.";
export const ALREADY_HAVE_AN_ACCOUNT = "Already have an account?";
export const SIGN_IN = "Sign in";
export const TERMS_AND_CONDITIONS = "Terms & Conditions";
export const PRIVACY_POLICY = "Privacy Policy";
export const WELCOME = "Welcome back";
export const SIGN_IN_TO_CONTINUE = "Sign in to continue to AtlasId.";
